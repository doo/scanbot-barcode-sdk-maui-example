...
public class BarcodeScanAndCountActivity : AppCompatActivity, IOnApplyWindowInsetsListener,
    BarcodePolygonsStaticView.IBarcodeItemViewBinder, BarcodePolygonsStaticView.IBarcodeItemViewFactory
{
    ...
    protected override void OnCreate(Bundle savedInstanceState)
    {
        ...
        var barcodeScanner = barcodeScannerResult.Get<IBarcodeScanner>();
        ...
        //         fillHighlightedColor: Android.Graphics.Color.Black,
        //         fillColor: Android.Graphics.Color.Yellow,
        //         strokeColor: Android.Graphics.Color.AliceBlue,
        //         strokeHighlightedColor: Android.Graphics.Color.Orange
        //     ));
